...
export const metadata: Metadata = {
  title: "F1 Championship 2024 - Participating Teams & Drivers",
  description: "Discover the participating Formula 1 teams and their star drivers competing in the 2024 world championship. Get race schedules, team info, and exclusive content.",
  keywords: "Formula 1, F1 teams, F1 drivers, 2024 championship, racing, Mercedes, Ferrari, Red Bull, McLaren",
  metadataBase: new URL("https://f1championship.com"),
  alternates: {
    canonical: "https://f1championship.com"
  },
  openGraph: {
    title: "F1 Championship 2024 - Participating Teams & Drivers",
    description: "Experience the pinnacle of motorsport with participating F1 teams and legendary drivers competing for the world championship",
    url: "https://f1championship.com",
    siteName: "F1 Championship",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763637641461-rl55czhs.jpg",
        alt: "Formula 1 racing car championship"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Championship 2024 - Participating Teams & Drivers",
    description: "Experience the pinnacle of motorsport with participating F1 teams and legendary drivers",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763637641461-rl55czhs.jpg"]
  },
  robots: {
    index: true,
    follow: true
